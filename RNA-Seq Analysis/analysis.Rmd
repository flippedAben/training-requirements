...
The following is a table of counts for six genes, not yet normalized.
...
of what the count data look like. Each number in the table represents how many
times we saw a gene in a sample. For example, in the first row of the first
column, we counted 12,091 instances of the TSPAN6 gene (ID ENSG00000000003.14)
when we executed the run `SRR309133` on a sample of cells taken from the
temporal cortex of a brain with Autism.
