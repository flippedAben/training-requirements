...
ggplot(data = head(data_popden, n = num_countries_shown)) +
    geom_bar(
        ...
        stat = "identity") +
    labs(title = str_glue(num_countries_shown, " most population dense countries 1962-2007"),
        x = "Average population density (people per sq. km of land)",
        y = "Country")
```
