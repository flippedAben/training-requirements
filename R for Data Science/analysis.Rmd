...
We import some libraries we'll use later in this document.
...
throw away rows that have a NA value for either variable.
...
## 3. Pearson correlation of CO2 emissions and GDP in 1962
...
to the continents and energy usages. Here's a frequency graph of that.
...
relationships in the data. First, we check if the data satisfy the assumptions
required to use ANOVA.
...
The data come from different continents and are at least 5 years apart. Due to this, assume
...
We group the data by country and take the average population density across the
years.
...
the change in life expectancy since 1962. The scatter plots shows this data for
